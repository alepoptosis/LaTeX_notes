...
\usepackage{verbatim} % allows a multiple-lines verbatim environment
% (like using \verb but more flexible)

% new command for macro section
\newcommand{\omg}[1][John]{{#1} was \textbf{shocked} beyond measure!}

% new environment for macro section
...
Use \verb+\textbf{}+ \textbf{for bold!} \\ % \verb ensures a command is printed
Use \verb+\textit{}+ \textit{for italics!} \\ % instead of executed
